...
def test_addition():
    ...
    assert simple_calculator("add", 1.5, 2.5) == 4.0   # Test for float numbers
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 2.5, 1.5) == 1.0 # Test for float numbers
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 1.5, 2.5) == 3.75 # Test for float numbers
...
def test_division():
    ...
    assert simple_calculator("divide", 2.5, 0.5) == 5.0 # Test for float numbers
